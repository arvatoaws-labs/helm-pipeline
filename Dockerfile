...
# base
RUN dnf upgrade -y && dnf install -y sed wget curl kubernetes1.35-client git openssh-clients jq bc findutils unzip gawk openssl procps-ng which file ping clang
